...
//		"WINNER"
     ...
     *
     * @return an array containing the names of the properties interesting for a target of the
     * specified type
    ...
    public static String getTargetType(String[] givenProperties) {
        ...
        for (int p = 0; p < givenProperties.length; p++)
            propSet.add(givenProperties[p].toLowerCase());
     ...
     * @return dossier
     * @param    target                the target string
     * @param    targetType            the target type (if set to null, the target type will be determined
     * automatically from the given properties)
    ...
    /**
     * register an additional type of target (hard coded are PERSON, ORGANIZATION, EVENT,
     * ENTERTAINMENT and THING)
     *
    ...
    /**
     * @return the names of the properties contained in this dossier (regardless if they already
     * have a value associated with them or not)
     */
    ...
    /**
     * @return the names of the properties in this dossier that do not yet have a value associated
     * with them
     */
