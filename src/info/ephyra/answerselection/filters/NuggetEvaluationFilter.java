...
//		instances.add(this);
    ...
    /**
     * set the ID of the next target, so upcoming results can be checked against the respective
     * nuggets
     *
...
//					line += ";" + instance.lastOk[i] + ";" + instance.lastVital[i] + ";;";
     ...
     *
     * @return the tokens of the specified nugget String not contained in the specified result
     * String
