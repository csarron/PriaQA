...
//					  rep.charAt(rep.length() - 1);
     ...
     * @return <code>true</code>, iff this object is the same as the <code>o</code> argument
     */
     ...
     * @return a negative integer, zero or a positive integer as this <code>AnswerPattern</code> is
     * less than, equal to or greater than the specified <code>AnswerPattern</code>
     */
     ...
     * @return array of PROPERTY objects or an empty array, if the sentence does not match the
     * pattern
     */
