...
public class Result implements Comparable<Result>, Serializable {
     ...
     * @return a negative integer, zero or a positive integer as this result is less than, equal to
     * or greater than the specified result
     */
...
//			return answer.compareTo(result.getAnswer());  // tie-breaking
     ...
     *
     * @return <code>Query</code> used to obtain this result or <code>null</code>
     */
