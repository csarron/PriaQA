...
/**
 * Extracts predicate-argument structures from a question. At first, the question string is
 * transformed into a statement with a dummy argument, then the predicates are extracted and finally
 * the dummy argument is dropped.
 *
...
//			if (!lastToken.matches(BE_P) && !lastToken.matches(IGNORE_P)) return true;
    ...
    /**
     * Transforms a phrase into a regular expression that matches the phrase, allowing differences
     * regarding whitespaces and punctuation and quotation marks.
     *
