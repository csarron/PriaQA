...
/**
 * Feature extractor for English answer type classification. <p> See {@link
 * info.ephyra.questionanalysis.atype.extractor.EnglishFeatureExtractor#initialize initialize} for a
 * description of the input properties required by this class. <p> See {@link
 * info.ephyra.questionanalysis.atype.extractor.EnglishFeatureExtractor#createInstance
 * createInstance} for a description of the features extracted by this class. <p> See {@link
 * info.ephyra.questionanalysis.atype.extractor.EnglishFeatureExtractor#loadFile loadFile} for a
 * specification of the input file format.
 *
...
public class EnglishFeatureExtractor extends FeatureExtractor {
    ...
    /**
     * Creates and populates an Instance from a QuestionAnalysis object.  All features are binary
     * features of one of the following types:</p>
     *
     * Word-level features: <ul> <li>UNIGRAM : individual words in the question <li>BIGRAM : pairs
     * of adjacent words in the question <li>WH_WORD : the wh-word in the question if one exists
     * </ul>
     *
     * Syntactic features: <ul> <li>MAIN_VERB: the syntactic head of the sentence, as defined in
     * {@link edu.cmu.lti.chineseNLP.util.TreeHelper TreeHelper} <li>FOCUS_ADJ : the adjective
     * following a wh-word (e.g. 'long' in 'How long is it?') <li>WH_DET : whether or not the
     * wh-word is the determiner of a noun phrase, as in 'which printer' </ul>
     *
     * Semantic features: <ul> <li>FOCUS_TYPE : the semantic type of the focus word, </ul>
     */
