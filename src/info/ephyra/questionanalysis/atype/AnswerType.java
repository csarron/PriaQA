...
//  private static final Logger log = Logger.getLogger(AnswerType.class);
     ...
     * provided
     *
     * @param level      A int indicating the level of this answer type in answer type hierarchy
     ...
     * @param confidence A double indicating the confidence score
     * @param type       A String indicating the type
     * @param subtypes   A List containing subtype information about the current answer type
     */
