...
public class TermExpander {
     ...
     * @param strict             iff <code>true</code>, the threshold for the maximum number of
     *                           expansions is applied strictly even if that means that some of a
     *                           number of expansion with equal weights have to be dropped randomly
     ...
     *
     * @param expansions expansions along with their weights
     * @param strict     iff <code>true</code>, the threshold for the maximum number of expansions
     *                   is applied strictly even if that means that some of a number of expansion
     *                   with equal weights have to be dropped randomly
     * @return minimum weight of an expansion in the reduced map
     */
    public static double cutOffExpansions(Map<String, Double> expansions,
                                          boolean strict) {
