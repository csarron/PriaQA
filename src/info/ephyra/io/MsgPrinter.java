...
public class MsgPrinter {
     ...
     *
     * @param enable <code>true</code> to enable status messages, <code>false</code> to disable
     *               them
     */
     ...
     *
     * @param enable <code>true</code> to enable error messages, <code>false</code> to disable them
     */
    ...
    public static synchronized void printStatusMsg(String status) {
        if (statusMsgs)
            printMessage("timestamp: " + (System.currentTimeMillis() - OpenEphyraServer.timestamp)
                    + " " + getTimestamp() + ": " + status);
    }
     ...
     * set the log file
     *
     * @param    logFile        the path and name of the filte to write log entries to (in addition to
     * System.out)
     */
