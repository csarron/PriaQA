...
public class OpenNLP {
     ...
     * @return array of sentences in the text or <code>null</code>, if the sentence detector is not
     * initialized
     */
     ...
     * @return array of tokens or <code>null</code>, if the tokenizer is not initialized
     */
     ...
     *
     * @param text text to tokenize
     * @return string of space-delimited tokens or <code>null</code>, if the tokenizer is not
     * initialized
     */
     ...
     * @return subsequence of the original string or the input text, iff there is no such
     * subsequence
     */
     ...
     * @return tagged sentence or <code>null</code>, if the tagger is not initialized
     */
     ...
     * @return array of POS tags or <code>null</code>, if the tagger is not initialized
     */
    public static String[] tagPos(String[] sentence) {
        return (tagger != null) ? tagger.tag(sentence) : null;
    }
     ...
     * @return array of chunk tags or <code>null</code>, if the chunker is not initialized
     */
     ...
     * @return parse of the sentence or <code>null</code>, if the parser is not initialized or the
     * sentence is empty
     */
