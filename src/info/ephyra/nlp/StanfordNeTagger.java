...
public class StanfordNeTagger {
     ...
     * @return NEs per sentence and NE type, using a HashMap since the types might change with the
     * model
     */
     ...
     * @return NEs per NE type, using a HashMap since the types might change with the model
     */
