...
//				quantityPatternMaxTokens[p] = quantityPatternMaxTokensList.get(p);
     ...
     * @return <code>true</code> iff there is a model-based tagger for one of these types
     */
     ...
     *
     * @param neTypes NE types
     * @return <code>true</code> iff there is a model-based tagger for each of these types
     */
     ...
     * dictionaries.
     *
     * @param threshold the new value for the edit distance threshold for fuzzy-lookups in
     *                  dictionaries
     */
     ...
     * @return NEs of the particular type per sentence or <code>null</code>, if the ID is invalid
     */
    @SuppressWarnings("unchecked")
