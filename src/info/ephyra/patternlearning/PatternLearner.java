...
public class PatternLearner {
     ...
     * @return <code>true</code>, iff the interpretations could be written to resource files
     */
...
//			Search.addKnowledgeMiner(new IndriKM(indriServers, true));
     ...
     *
     * @param args argument 1: name of the question file<br> argument 2: name of the answer file<br>
