...
public class PatternExtractor {
     ...
     * @return sentence with TARGET tags or <code>null</code>, if the sentence does not contain the
     * TARGET
     */
     ...
     * @param nes      the NEs in the sentence
     * @return sentence with PROPERTY tags or <code>null</code>, if the sentence does not contain
     * the answer
     */
     ...
     * @param nes      the NEs in the sentence
     * @return sentence ready for pattern extraction or <code>null</code>, if there is no TARGET or
     * PROPERTY object in the input sentence
     */
