...
public class Properties extends HashMap<String, String> {
     ...
     * @param remove_prefix if true, strips the prefix off of all key values in the returned
     *                      Properties object
     * @return a new Properties object containing only those entries from this Properties object
     * whose keys match the given prefix
     */
    ...
    /**
     * @return a java.util.Properties object containing equivalent key-value entries
     */
