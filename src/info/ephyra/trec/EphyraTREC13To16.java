...
//		}
     ...
     *
     * @param args argument 1: questionfile<br> [argument 2: tag=runtag (uniquely identifies the
     *             run, also used as output file name, if not set an unambiguous tag is generated
     *             automatically)]<br> [argument 3: log=logfile (if not set an unambiguous file name
     *             is generated automatically)]<br> [argument 4: lin=input_logfile (specifies a
     *             separate logfile that is used as a source for answers to some of the	questions,
     *             if not set the standard log file is used)]<br> [argument 5: lflags=[f][l][o]
     *             (answers to these types of questions are loaded from the log file instead of
     *             querying Ephyra,	e.g. "flo" for factoid, list and other questions)]<br> [argument
     *             6: fp=factoid_patternfile]<br> [argument 7: lp=list_patternfile]
     */
