...
public class TREC13To16Parser {
     ...
     * @return array of results or <code>null</code> if the question could not be found in the log
     * file
     */
...
//						line = "<![CDATA[" + line.trim() + "]]>";
     ...
     * @param correct  for each answer a flag that is true iff the answer is correct or
     *                 <code>null</code> if the answers were not evaluated
